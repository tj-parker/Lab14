...
function populateForm() {
  ...
  listEl.setAttribute('id','cartList');
...
function addSelectedItemToCart() {
  ...
  cart.addItem(selectEl.value, inputEl.value);
}
...
function updateCartPreview() {
  ...
  let divEl = document.getElementById('cartList');
  let newestItem = cart.items[cart.items.length-1]
    let li = document.createElement('li');
    li.textContent = newestItem.product + ' x ' + newestItem.quantity;
